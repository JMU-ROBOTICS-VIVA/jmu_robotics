...
def generate_launch_description():
    ...
    pkg_jmu_tb4_bringup = get_package_share_directory('jmu_tb4_bringup')
    ...
    param_file_cmd = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [pkg_jmu_tb4_bringup, 'config', 'turtlebot4.yaml']),
    ...
    create3_param_file = PathJoinSubstitution(
        [pkg_jmu_tb4_bringup, 'config', 'republisher.yaml'])
    ...
    oakd_param_file = PathJoinSubstitution(
        [pkg_jmu_tb4_bringup, 'config', 'oakd_lite.yaml'])
    ...
    actions = [
            ...
            IncludeLaunchDescription(
                ...
                launch_arguments=[('model', 'lite'),
                                  ...
                                  ('create3_param_file', create3_param_file)]),

            Node(
                package='jmu_tb4_bringup',
                executable='lidar_power',
                name='lidar_power',
                output='screen',
            ),
